...
export default function CardDetail({ video, views, options, props }) {
  ...
  return (
    <div className="Dcard">
      <video
        src={`../../public/Videouploads/${videoPath}`}
      ...
      <div className={classes.views}>
        ...
        <div className="like">
          ...
          <IconButton>
            <PlaylistAdd />
            <Typography style={{ marginLeft: "2px", fontSize: "12px" }}>
              save
            </Typography>
          </IconButton>
      ...
      <div className="detail-discription">
        <div
          className={
            showDescription
              ? "discriotion-content discription"
              : "discriotion-content"
          }
        >
          <p>{description}</p>
