...
const Navbar = (props) => {
  ...
  return (
    <>
          ...
          <Toolbar>
            <div className="navbar-context">
              ...
              <form
                ...
                onSubmit={(props, e) => handleSubmit(props, e)}
              >
                <input
                  type="text"
                  name="search"
      ...
      {user && (
        <div
          className={manue ? "sidebar-right" : "sidebar-right-toggle"}
          ref={ref}
        >
          <div className="sidebar-lg">
            <div className="sidebar-right-hedader">
              ...
              <div className="card-body-content">
                <h5 className="side-title">{user.name}</h5>
                <h5 style={{ color: "#8b8b8b",fontSize:"12px"}}>{user.email}</h5>
                <h5>
            ...
            ,
            <SideBarLg
              SidebarLgHome={SidebarLgHomeRight}
              SidebarHistory={SidebarHistoryRight}
              exit
            />
          </div>
        </div>
