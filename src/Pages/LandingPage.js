...
import {
  ...
  SidebarHistory,
  SidebarSubs,
} from "../Pages/UploadVideo/UloadUtilty";
  ...
  return (
    <div className={classes.root}>
      <div className={toggle ? "mainContent" : "mainContent mainContentSm"}>
        ...
        <div
          className={
            toggle ? "allBody-content-lg allpody-fixed" : "allBody-content-lg"
          }
        >
          {isNew ? (
            <div className="welcome">
              ...
              <h4 className="welcome-text">
                welcome to my Youtube clone Application where you can do pretty
                much everything you do in the Real Youtube-App like creating new
                Account ,<strong>Singing In</strong> or{" "}
                <strong>singing Out</strong>, <strong>Upploading video</strong>{" "}
                , <strong>Commenting</strong>, <strong>liking </strong> or{" "}
                <strong>disliking</strong> of poth videos and comments , and
                last but not least <strong>putting your profile Picture</strong>{" "}
                or <strong>changing it.</strong>
              </h4>
